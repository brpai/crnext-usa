...
const I18N = {
  ...
  es: {
    ...
    'footer.tagline': 'Seminuevos Premium. Lo Mejor de Orlando.', 'footer.inventory': 'Inventario', 'footer.company': 'Empresa', 'footer.legal': 'Legal', 'footer.allInventory': 'Todos los Vehículos', 'footer.testDrive': 'Test Drive', 'footer.contact': 'Contacto', 'footer.privacy': 'Política de Privacidad', 'footer.terms': 'Términos de Servicio', 'nav.investor': 'Portal del Inversionista', 'footer.rights': 'Todos los derechos reservados.', 'footer.by': 'Desarrollado por',
