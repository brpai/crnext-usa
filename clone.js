...
const I18N = {
  en: {
    ...
    'hero.chip': 'No dealer fees · Premium Pre-Owned', 'hero.headline': 'Your Next Car Starts Here',
    ...
    'contact.title': 'Get in Touch', 'contact.address': 'Address', 'contact.directions': 'Get Directions', 'contact.hours': 'Business Hours', 'contact.hoursVal': 'Mon – Sat: 10:00 AM – 7:00 PM', 'contact.phone': 'Phone', 'contact.email': 'Email', 'contact.whatsapp': 'Chat on WhatsApp',
  ...
  pt: {
    ...
    'hero.chip': 'Sem taxas de concessionária · Seminovos Premium', 'hero.headline': 'Seu Próximo Carro Começa Aqui',
    ...
    'contact.title': 'Entre em Contato', 'contact.address': 'Endereço', 'contact.directions': 'Como Chegar', 'contact.hours': 'Horário de Funcionamento', 'contact.hoursVal': 'Seg – Sáb: 10:00 – 19:00', 'contact.phone': 'Telefone', 'contact.email': 'E-mail', 'contact.whatsapp': 'Falar no WhatsApp',
  ...
  es: {
    ...
    'hero.chip': 'Sin cargos de concesionario · Seminuevos Premium', 'hero.headline': 'Tu Próximo Auto Empieza Aquí',
    ...
    'contact.title': 'Contáctanos', 'contact.address': 'Dirección', 'contact.directions': 'Cómo Llegar', 'contact.hours': 'Horario de Atención', 'contact.hoursVal': 'Lun – Sáb: 10:00 AM – 7:00 PM', 'contact.phone': 'Teléfono', 'contact.email': 'Correo', 'contact.whatsapp': 'Chatear en WhatsApp',
    ...
    'footer.tagline': 'Seminuevos Premium. Lo Mejor de Orlando.', 'footer.inventory': 'Inventario', 'footer.company': 'Empresa', 'footer.legal': 'Legal', 'footer.allInventory': 'Todos los Vehículos', 'footer.testDrive': 'Test Drive', 'footer.contact': 'Contacto', 'footer.privacy': 'Política de Privacidad', 'footer.terms': 'Términos de Servicio', 'footer.investor': 'Portal del Inversionista', 'footer.rights': 'Todos los derechos reservados.', 'footer.by': 'Desarrollado por',
